...
public class User_Receipt extends javax.swing.JPanel {
...
//        rowSorter.setSortable(0, false);
    ...
    public void initTableData() {
        ...
        List<Receipt> rcList = ReceiptService.getAllReceipt(User_Main.userID);
        DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
        Object[] row = new Object[5];

        for (int i = 0; i < rcList.size(); i++) {
            row[0] = rcList.get(i).getId();
            row[1] = rcList.get(i).getOrderDate();
            Boolean status = rcList.get(i).getStatus();
...
//        TableRowFilterSupport.forTable(jTable1).searchable(true).apply();
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Receipt Name", "Ordered Date", "Status"
            }
        ) {
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        String statustxt = model.getValueAt(index, 2).toString();  
        Boolean status = Boolean.TRUE;
        if (statustxt == "Not Paid") {
            status = Boolean.FALSE;
        }
        
        User_Receipt_Detail.main(id, status);
